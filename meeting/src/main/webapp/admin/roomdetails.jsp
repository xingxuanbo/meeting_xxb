                    ...
                    <fieldset>
                        ...
                        <table class="formtable">
                            <tr>
                                <td>门牌号:</td>
                                <td>
                                    <input id="roomnumber" type="text" value="${requestScope.room.roomnum }" maxlength="10"/>
                                </td>
                            </tr>
                            <tr>
                                <td>会议室名称:</td>
                            ...
                            <tr>
                                <td>最多容纳人数：</td>
                                <td>
                                    <input id="roomcapacity" type="text" value="${requestScope.room.capacity }"/>
                                </td>
                            </tr>
                            <tr>
                                <td>当前状态：</td>
                            ...
                            <tr>
                                <td>备注：</td>
                                <td>
                                    <textarea id="description" maxlength="200" rows="5" cols="60" >${requestScope.room.description }</textarea>
                                </td>
                            </tr>
                            <tr>
